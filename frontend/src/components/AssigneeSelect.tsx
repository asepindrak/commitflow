...
export function AssigneeSelect({
    ...
    // debug: lihat mapping di console
    console.debug("Assignee colors:", options.map(o => ({ name: o.value, ...o.meta })));
            ...
            <div className="flex items-center gap-2 text-sm leading-none">
                <span
                    ...
                    style={{
                        ...
                        height: 10,
                        background: dot,
                        boxShadow: dark ? `0 0 0 6px ${hsla(opt.meta.hue, 80, 50, 0.06)}` : undefined,
                    }}
                />
                <span>{opt.label}</span>
            </div>
    ...
    const SingleValue = (props: any) => {
        ...
        return (
            <div className="flex items-center gap-2 text-sm leading-none" style={{ color: text }}>
                <span
                    className="inline-block rounded-full"
